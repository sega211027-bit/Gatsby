...
# 다시 재생 버튼 클릭 시 숫자를 올려서 브라우저가 새 콘텐츠로 인식하게 함
...
if not is_admin:
    if os.path.exists(JSON_FILE):
        ...
        with col1:
            ...
            # 토글: 이 값은 JS 내부로 전달되며 변경 시에도 영상이 튀지 않음
        ...
        with col2:
            ...
            # [해결책] TypeError를 유발하는 'key'를 삭제했습니다.
            # 대신 스크립트 경로에 ?v={reloader}를 붙여 버튼 클릭 시에만 리로드를 유도합니다.
            yt_html = f"""
            <div id="player"></div>
            ...
            # st.empty()를 사용하여 컨테이너를 깨끗하게 관리합니다.
