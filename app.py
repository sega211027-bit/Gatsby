...
if os.path.exists(JSON_FILE):
    ...
    # 🔹 사이드바에 무한 반복 토글 체크박스
    st.session_state.loop_enabled = st.sidebar.checkbox("♻️ 무한 반복", value=st.session_state.loop_enabled)
    ...
    # 🔹 json.dumps()로 Boolean 안전 전달
    loopEnabled = json.dumps(st.session_state.loop_enabled)
    ...
    components.html(f"""
        ...
        <script>
          ...
          var start = {s_val};
          var end = {e_val};
          var loopEnabled = {loopEnabled}; // Python Boolean → JS Boolean
